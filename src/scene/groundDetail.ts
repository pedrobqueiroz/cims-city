...
const PLANTED_AREAS: readonly PlantedArea[] = [
  ...
  { position: [-15, 0, 24], size: [10, 8] },
  // North of New ZeMA
  { position: [30, 0, -30], size: [12, 6] },
  // East of HyCatt
  { position: [48, 0, 20], size: [8, 10] },
  // West of UdS
  { position: [-52, 0, 35], size: [6, 10] },
  // Central green area
  { position: [5, 0, 10], size: [14, 10] },
  // South of CiMS
  { position: [-20, 0, -32], size: [18, 6] },
  // Between districts
  { position: [10, 0, -15], size: [8, 6] },
  { position: [-10, 0, 15], size: [6, 8] },
];
